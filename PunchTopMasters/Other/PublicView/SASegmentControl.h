...
@protocol SASegmentControlDelegate;
@interface SASegmentControl : UIView<UIScrollViewDelegate>
{
...
@property (nonatomic, weak)   id<SASegmentControlDelegate>                     segmentControlDelegate;
 ...
 * @result tab个数
 */
- (NSUInteger)numberOfTab:(SASegmentControl *)view;
 ...
 */
- (UIViewController *)slideSwitchView:(SASegmentControl *)view viewOfTab:(NSUInteger)number;
 ...
 */
@optional
- (void)slideSwitchView:(SASegmentControl *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(SASegmentControl *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(SASegmentControl *)view didselectTab:(NSUInteger)number;
