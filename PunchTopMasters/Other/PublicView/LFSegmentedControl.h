...
@class LFSegmentedControl;

typedef void (^IndexChangeBlock)(NSInteger index);
typedef NSAttributedString *(^HMTitleFormatterBlock)(LFSegmentedControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected);
...
@interface LFSegmentedControl : UIControl
