...
@property (nonatomic, strong) LFSegmentedControl *hmSegmentedControl;
...
-(void)setSegmentControlDelegate:(id<SASegmentControlDelegate>)segmentControlDelegate
{
...
-(void)createTopView
{
    ...
    self.hmSegmentedControl = [[LFSegmentedControl alloc] initWithFrame:CGRectMake(0, 0, viewWidth, kHeightOfTopScrollView)];
...
-(void)createImageTopView
{
    ...
    self.hmSegmentedControl  = [[LFSegmentedControl alloc] initWithSectionImages:sectionImagesArray
...
- (void)segmentedControlChangedValue:(LFSegmentedControl *)segmentedControl {
...
//        CGFloat doublePage = scrollView.contentOffset.x / self.bounds.size.width;
//        int intPage = (int)(doublePage + 0.5);
//        LFLog(@"--------%d",intPage);
//        [self.hmSegmentedControl setSelectedSegmentIndex:intPage animated:YES];
//        [self segmentClicked:intPage];
//    }
