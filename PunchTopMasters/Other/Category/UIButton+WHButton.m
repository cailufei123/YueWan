...
-(void)navigationTitles:(NSString *)title titleFont:(CGFloat)font{
    
    [self setTitle:title forState:UIControlStateNormal];
    self.titleLabel.font = [UIFont systemFontOfSize:font];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self setTitleColor:[[SVGloble colorWithHexString:@"#ffffff"] colorWithAlphaComponent:1] forState:UIControlStateSelected];
    //    self.selected = YES;
