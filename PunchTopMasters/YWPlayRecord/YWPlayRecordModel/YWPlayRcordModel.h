...
@interface YWPlayRcordModel : NSObject
...
@property(nonatomic,copy)NSString *huanId ;//
@property(nonatomic,copy)NSString *ID ;//
@property(nonatomic,copy)NSString *isComment ;// 0:没有评价，1：已经评价 ,
...
@property(nonatomic,copy)NSString *roomHuanId ;//
...
@property(nonatomic,copy)NSString *roomUserIcon;//
...
@property(nonatomic,copy)NSString *userGameFlowId ;//
...
@property(nonatomic,copy)NSString *userType ;// 用户类型 1 房主
@end
